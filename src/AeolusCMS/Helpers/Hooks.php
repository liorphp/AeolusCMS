...
/**
  ...
  */
  class Hooks
  {
     ...
     * @param ReflectionMethod $function_to_add The name of the function to be called when the filter is applied.
     * @param int $priority optional. Used to specify the order in which the functions associated with a particular action are executed (default: 10). Lower numbers correspond with earlier execution, and functions with the same priority are executed in the order in which they were added to the action.
     * @param int $accepted_args optional. The number of arguments the function accept (default 1).
     * @return boolean true
     */
    public function add_filter($tag, $function_to_add, $priority = 0, $accepted_args = 1) {
      $idx =  $this->_filter_build_unique_id($tag, $function_to_add->name, $priority);
      $this->filters[$tag][$priority][$idx] = array('class' => $function_to_add->class , 'function' => $function_to_add->name, 'accepted_args' => $accepted_args);
